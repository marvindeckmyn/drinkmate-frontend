...
const CreateGameModal = ({ onGameCreated, authToken, languages, categories }) => {
  ...
  return (
    <>
      ...
      <div className="create-game-modal-yes">
        <h2>{t('CreateGameModal.createGameButton')}</h2>
        ...
        <div>
          ...
          <div>
            ...
            {imagePreviewUrl && (
              <div>
                <img id="thumbnail" src={imagePreviewUrl} alt="Uploaded game" style={{ width: '359.99px', height: '202.49px' }} />
              </div>
            )}
          </div>
          {/* Necessities */}
